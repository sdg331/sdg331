...
동양미래대학교 **인공지능소프트웨어학과** 재학 중입니다.
데이터에서 의미를 찾아내는 **빅데이터 분석**과, 그것을 실제 서비스로 연결하는 **AI 엔지니어링**에 관심이 있습니다.
...
- **빅데이터 분석** — 데이터 수집 · 전처리 · 분석 · 시각화
- **AI / LLM** — LLM 기반 서비스 개발, LLM-as-Judge 평가 파이프라인
- **소프트웨어 개발** — 백엔드(FastAPI), 임베디드(Raspberry Pi)
